        ...
        <div class="row">
            ...
            <div class="card-3" id="LoginCard">
                ...
                <div class="form-group">
                    <label for="email" id="administratieText"><b>Leerlingnummer</b></label>
                    <input type="text" class="form-control" id="email" aria-describedby="emailHelp" name="email" placeholder="Voer je Leerlingnummer in">
                </div>
